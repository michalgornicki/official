  ...
  return (
    <div className="App">
      ...
      <div className="container1">
        ...
        <h3 class="small">Since July 2019 I'm developing web projects and learning new frontend skills. I'm looking forward for new challenges to work and grow. </h3>
        </div>
