...
function App() {
  return (
    <div className="App">
      ...
      <div className="skill">REACT <div className="skill-description">I have strong theoretical foundations. React mostly is clear and smart library. I'm now working on React projects.</div></div>
