  ...
  return (
    <div className="App">
      ...
      <div className="container2">
        ...
        <a href="https://michalgornicki.github.io/restaurant/"><div className="project-slide">Royal Cookery - strona restauracji.<img className="project website1"/></div></a>
        <a href="https://michalgornicki.github.io/artgallery/"><div className="project-slide"><img className="project website2"/></div></a>
        <div className="project-slide"><img className="project website3"/></div>
        <div className="project-slide"><img className="project website4"/></div>
