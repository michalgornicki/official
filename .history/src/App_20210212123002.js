  ...
  return (
    <div className="App">
      ...
      <div className="container2">
        ...
        <a href="https://michalgornicki.github.io/restaurant/"><div className="project-slide"><img className="project website1"/>Royal Cookery - strona restauracji.</div></a>
        <a href="https://michalgornicki.github.io/artgallery/"><div className="project-slide"><img className="project website2"/>Royal Cookery - strona restauracji.</div></a>
        <div className="project-slide"><img className="project website3"/>Royal Cookery - strona restauracji.</div>
        <div className="project-slide"><img className="project website4"/>Royal Cookery - strona restauracji.</div>
        <div className="project-slide"><img className="project"/>Royal Cookery - strona restauracji.</div>
        <div className="project-slide"><img className="project"/>Royal Cookery - strona restauracji.</div>
        </div>
