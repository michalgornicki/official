...
function App() {
  return (
    <div className="App">
      ...
      <h2 class="header">Skills & Techs</h2>

      <div className="skill-wrapper">
      <div className="skill blue">HTML <div className="skill-description">I feel strong in HTML.</div></div>
      <div className="skill green">CSS <div className="skill-description">I know CSS very well. Styling, positioning, animations are familiar to me. I also used CSS frameworks as Bootstrap and Tailwind. </div></div>
      ...
      <div className="skill green">GIT/GITHUB <div className="skill-description">I'm using simple Github options for maintaining my projects.</div></div>
      ...
      <div className="skill green">VISUAL STUDIO CODE <div className="skill-description">I switched from Atom and loved VSCode from first sight. My favourite code editor.</div></div>
      ...
      <div className="skill red">CSS LIBRARIES <div className="skill-description">Worked a lot in Photoshop retouching photos.</div></div>
      </div>
