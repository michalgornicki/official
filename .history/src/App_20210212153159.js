...
function App() {
  return (
    <div className="App">
      ...
      <div className="skill blue" data-aos="fade-up" data-aos-delay="300"><span>HTML</span> <div className="skill-description">I feel strong in HTML.</div></div>
      <div className="skill violet" data-aos="fade-up" data-aos-delay="600"><span>CSS</span> <div className="skill-description">I know CSS very well. Styling, positioning, animations are familiar to me. I also used CSS frameworks as Bootstrap and Tailwind. </div></div>
      <div className="skill red" data-aos="fade-up" data-aos-delay="900"><span>JAVASCRIPT</span> <div className="skill-description">I know javascript pretty well. I practice this language to get used to more advanced concepts.</div></div>
      <div className="skill blue" data-aos="fade-up" data-aos-delay="1200"><span>REACT</span> <div className="skill-description">This is my main focus. I'm now working on React projects.</div></div>
      <div className="skill violet" data-aos="fade-up" data-aos-delay="1500"><span>GIT/GITHUB</span> <div className="skill-description">I'm using simple Github options for maintaining my projects.</div></div>
      <div className="skill red" data-aos="fade-up" data-aos-delay="1800"><span>BOOTSTRAP</span> <div className="skill-description">I used Bootstrap for few projects.</div></div>
      <div className="skill blue" data-aos="fade-up" data-aos-delay="2100"><span>ATOM</span> <div className="skill-description">I worked in Atom editor for about 12 months.</div></div>
      <div className="skill violet" data-aos="fade-up" data-aos-delay="2400"><span>VISUAL STUDIO CODE</span> <div className="skill-description">I switched from Atom and loved VSCode from first sight. My favourite code editor.</div></div>
      <div className="skill red" data-aos="fade-up" data-aos-delay="2700"><span>ADOBE PHOTOSHOP</span> <div className="skill-description">Worked a lot in Photoshop retouching photos.</div></div>
      <div className="skill blue" data-aos="fade-up" data-aos-delay="3000"><span>JS/CSS LIBRARIES</span> <div className="skill-description">I used number of libraries.</div></div>
      </div>
