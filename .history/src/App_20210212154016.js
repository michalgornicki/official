...
function App() {
  return (
    <div className="App">
      ...
      <div className="skill blue" data-aos="zoom-up" data-aos-delay="1500"><span>GIT/GITHUB</span> <div className="skill-description">I'm using simple Github options for maintaining my projects.</div></div>
