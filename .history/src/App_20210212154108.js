...
function App() {
  return (
    <div className="App">
      ...
      <div className="skill red" data-aos="zoom-up" data-aos-delay="600"><span>JAVASCRIPT</span> <div className="skill-description">I know javascript pretty well. I practice this language to get used to more advanced concepts.</div></div>
      <div className="skill blue" data-aos="zoom-up" data-aos-delay="300"><span>REACT</span> <div className="skill-description">This is my main focus. I'm now working on React projects.</div></div>
