...
function App() {
  return (
    <div className="App">
      ...
      <div className="skill blue" data-aos="zoom-up" data-aos-delay="600"><span>REACT</span> <div className="skill-description">This is my main focus. I'm now working on React projects.</div></div>
      <div className="skill violet" data-aos="zoom-up" data-aos-delay="300"><span>GIT/GITHUB</span> <div className="skill-description">I'm using simple Github options for maintaining my projects.</div></div>
