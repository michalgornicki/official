...
function App() {
  return (
    <div className="App">
      ...
      <div className="skill red" data-aos="zoom-up" data-aos-delay="300"><span>BOOTSTRAP</span> <div className="skill-description">I used Bootstrap for few projects.</div></div>
      <div className="skill blue" data-aos="zoom-up" data-aos-delay="600"><span>ATOM</span> <div className="skill-description">I worked in Atom editor for about 12 months.</div></div>
      <div className="skill violet" data-aos="zoom-up" data-aos-delay="900"><span>VISUAL STUDIO CODE</span> <div className="skill-description">I switched from Atom and loved VSCode from first sight. My favourite code editor.</div></div>
      <div className="skill red" data-aos="zoom-up" data-aos-delay="600"><span>ADOBE PHOTOSHOP</span> <div className="skill-description">Worked a lot in Photoshop retouching photos.</div></div>
      <div className="skill blue" data-aos="zoom-up" data-aos-delay="300"><span>JS/CSS LIBRARIES</span> <div className="skill-description">I used number of libraries.</div></div>
      </div>
