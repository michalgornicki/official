...
function App() {
  return (
    <div className="App">
      ...
      <div className="focus-description"> <div className="focus-text"></div> Creating elegant and quality webpages, easy and nice to use. </div>
      <div className="focus-description">Perfect and faultless user experience for all devices.</div>
      <div className="focus-description">Clean and simple high-standard frontend code.</div>
      </div>
