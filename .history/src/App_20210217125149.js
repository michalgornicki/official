...
function App() {
  return (
    <div className="App">
      ...
      <div className="focus-description" data-aos="fade-up" data-aos-delay="300"><div className="focus-text">Elegant and quality webpages, easy and nice to use.</div> </div>
      <div className="focus-description" data-aos="fade-up" data-aos-delay="500"><div className="focus-text">Perfect and faultless user experience for all devices.</div></div>
      <div className="focus-description" data-aos="fade-up" data-aos-delay="700"><div className="focus-text">Clean and simple high-standard frontend code.</div></div>
      </div>
