...
function App() {
  return (
    <div className="App">
      ...
      <div className="contact"> <a href="">gornickimichal@gmail.com</a></div>
      <div className="contact"><a href="">m.me/username/micgornicki</a></div>
      <div className="contact"><a href="">https://www.facebook.com/micgornicki</a></div>
