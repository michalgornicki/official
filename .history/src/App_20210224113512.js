...
function App() {
  return (
    <div className="App">
      ...
      <div className="contact" data-aos="zoom-out-left"> <a href="mailto:gornickimichal@gmail.com">Gmail</a></div>
      <div className="contact" data-aos="zoom-out-left"> <a href="m.me/micgornicki">Messenger</a></div>
      <div className="contact" data-aos="zoom-out-left"> <a href="https://www.facebook.com/micgornicki">Facebook</a></div>
      <div className="contact" data-aos="zoom-out-left"> <a href="https://github.com/michalgornicki">Github</a></div>
      </div>
