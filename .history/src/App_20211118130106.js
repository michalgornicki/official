...
window.onscroll = function() {
    ...
    if (prevPosition > currentPosition || window.pageYOffset > 800) {
  ...
  return (
    <div className="App">
      ...
      <div className="navbar-items">
        <a href="#container1"><div className="navbar-item">Home</div></a>
        <a href="#container2"><div className="navbar-item">Projects</div></a>
        <a href="#container3"><div className="navbar-item">Skills</div></a>
        <a href="#container4"><div className="navbar-item">Services</div></a>
        <a href="#container5"><div className="navbar-item">Contact</div></a>
      </div>
      </div>
      <Profile />
      <Projects />
