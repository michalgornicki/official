...
import menu-close from "./menu-close.png";
  ...
  return (
    <div className="App">
      <div className="navbar">
        ...
        {toogleNavbar ?
          <img className="navbar-icon" src={menu} onClick={() => setToogleNavbar(false)} alt="" /> :
          <img className="navbar-icon" src={menu-close} onClick={() => setToogleNavbar(true)} alt="" />
        }
