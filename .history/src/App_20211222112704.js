...
import square from "./menu-close.png";
    ...
    <div className="App">
      ...
      <div className="navbar">
        ...
        <div className="scroll-container">
          <a href="#container1"><div className="scroll-button"></div></a>
          <a href="#container2"><div className="scroll-button"></div></a>
          <a href="#container3"><div className="scroll-button"></div></a>
          <a href="#container4"><div className="scroll-button"></div></a>
        </div>
      </div>
      <Profile />
      <Projects />
