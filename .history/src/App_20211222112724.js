    ...
    <div className="App">
      ...
      <div className="navbar">
        ...
        <div className="scroll-container">
          ...
          <a href="#container2"><img className="scroll-button"></div></a>
          <a href="#container3"><img className="scroll-button"></div></a>
          <a href="#container4"><img className="scroll-button"></div></a>
        </div>
      </div>
      <Profile />
      <Projects />
