    ...
    <div className="App">
      ...
      <div className="navbar">
        ...
        <div className="scroll-container">
          <a href="#container1"><img src={square} className="scroll-button"/></a>
          <a href="#container2"><img className="scroll-button"/></a>
          <a href="#container3"><img className="scroll-button"/></a>
          <a href="#container4"><img className="scroll-button"/></a>
        </div>
      </div>
      <Profile />
      <Projects />
