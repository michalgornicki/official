...
function App() {
  ...
  const scrolling = () => {
    ...
    let el2 = document.getElementById("container2")
    let el3 = document.getElementById("container3")
    let el4 = document.getElementById("container4")
    let el5 = document.getElementById("container5")
    let bottom = getBoundingClientRect().bottom
    console.log(bottom)
    if (el1.bottom < 0) {document.getElementsByClassName("scroll-button")[0].style.filter="opacity(0.5)"}
    else if (el2.bottom < 0) {document.getElementsByClassName("scroll-button")[0].style.filter="opacity(0.5)"}
