...
function App() {
  ...
  const scrolling = () => {
    ...
    console.log(el5)
    if (el1 < 0 || el2 > 0) {document.getElementsByClassName("scroll-button")[0].style.filter="opacity(0.5)"}
    else if (el5 < 0) {document.getElementsByClassName("scroll-button")[1].style.filter="opacity(0.5)"}
    else if (el2 < 0) {document.getElementsByClassName("scroll-button")[2].style.filter="opacity(0.5)"}
    else if (el3 < 0) {document.getElementsByClassName("scroll-button")[3].style.filter="opacity(0.5)"}
    else if (el4 < 0) {document.getElementsByClassName("scroll-button")[4].style.filter="opacity(0.5)"}
