...
const Contact = () => {
    ...
    return(
      ...
      <div className="contact contact-right"> <a href="m.me/micgornicki">Messenger</a></div>
      <div className="contact"> <a href="https://www.facebook.com/micgornicki">Facebook</a></div>
      <div className="contact contact-right"> <a href="https://github.com/michalgornicki">Github</a></div>
      </div>
