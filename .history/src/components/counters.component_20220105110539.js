...
const Counters = () => {
  ...
  const counter = () => {
    document.getElementById("container5").removeEventListener("mouseover", counter, true);
  ...
  if (document.getElementById("container5")) {document.getElementById("container5").addEventListener("mouseover", counter, true);}

  return (
    <div id="container5" onMouseOver={counter}>
