...
const Counters = () => {
  ...
  const counter = () => {
    ...
    var intervSpeed = setInterval(function () {
      if (i < 5) document.getElementsByClassName("counter1")[0].innerHTML = ++i;
      else {clearInterval(intervSpeed);
            document.getElementById("counter1").classList.remove("counter1")}
    }, 500);
  ...
  return (
    <div id="container5" onMouseEnter={counter}>
      <div className="counter-container d-flex justify-content-evenly w-50 m-auto h-100 text-center text-white display-6">
        <div className="d-flex flex-column">
          ...
          <div id="counter1" className="counter1">0</div>
