  ...
  return (
    <div id="container1">
      ...
      <div className="text-wrapper">
        ...
        <h3 className="small">
          Self-taught, skilled and pro-active front end developer since 2019. I'm looking forward for great challenges to work
          and grow. I can help you create every project.{" "}
        </h3>
