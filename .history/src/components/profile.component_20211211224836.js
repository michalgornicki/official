...
const Profile = () => {
  ...
  const mouseMove = (e) => {
    ...
    document.getElementsByClassName("profile-photo")[0].style.transform = "rotateY(" + mousePosX + "deg)";
    document.getElementsByClassName("profile-photo")[0].style.transform = "rotateX(" + mousePosX + "deg)";
