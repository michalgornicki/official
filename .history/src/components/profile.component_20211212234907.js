...
const Profile = () => {
  ...
  const mouseMove = (e) => {
    ...
    setMousePosX(X);
    setMousePosY(Y);
    document.getElementsByClassName("body")[0].style.filter = "brightness(" + parseFloat(mousePosY/400 - 5) + ") sepia(" + mousePosX/1500 + ")";
    document.getElementsByClassName("text-wrapper")[0].style.transform = "rotateX(" + parseFloat(mousePosY/100 - 5) + "deg) rotateY(" + mousePosX/100 + "deg)";
  };
