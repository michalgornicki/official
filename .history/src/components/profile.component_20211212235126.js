...
const Profile = () => {
  ...
  const mouseMove = (e) => {
    ...
    setMousePosX(X);
    setMousePosY(Y);
    document.getElementsByClassName("body")[0].style.filter = "brightness(" + mousePosY/400 - 10) + ") sepia(" + mousePosX/1500 + ")";
    document.getElementsByClassName("text-wrapper")[0].style.transform = "rotateX(" + parseFloat(mousePosY/100 - 5) + "deg) rotateY(" + parseFloat(mousePosX/100 - 5) + "deg)";
  };
