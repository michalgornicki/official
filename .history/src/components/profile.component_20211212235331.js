...
const Profile = () => {
  ...
  const mouseMove = (e) => {
    ...
    setMousePosX(X);
    setMousePosY(Y);
    document.getElementsByClassName("body")[0].style.filter = "brightness(" + mousePosY/400 + ") sepia(" + mousePosX/1000 + ")";
    document.getElementsByClassName("text-wrapper")[0].style.transform = "rotateX(" + parseFloat(mousePosY/200 - 25) + "deg) rotateY(" + parseFloat(mousePosX/200 - 2.5) + "deg)";
  };
