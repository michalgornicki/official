...
const Profile = () => {
  ...
  const bodyClick = () => {
    document.getElementsByClassName("part2")[0].style.backgroundPositionX = "0%";
    document.getElementsByClassName("part2")[0].style.animation = "1s";
  }
  
  return (
    <div id="container1">
            <div className="body" onClick={bodyClick} onMouseMove={mouseMove}>
