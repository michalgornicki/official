...
const Profile = () => {
  ...
  const mouseMove = (e) => {
    ...
    setMousePosX(X);
    setMousePosY(Y);
    document.getElementsByClassName("wallpaper")[0].style.filter = "brightness(" + parseFloat(mousePosY/500 + 0.5) + ") sepia(" + mousePosX/1500 + ")";
  ...
  window.onscroll = () => {
    ...
    console.log(scroll);
    document.body.style.backgroundColor = "rgb(" + 1453500/scroll + "," + 1453500/scroll + "," + 1453500/scroll + ")";
  }
