...
const Profile = () => {
  ...
  var text = "Self-taught, skilled, helpful and pro-active front end developer since 2019. Creating projects from templates or from scratch."

  var newtext = text.split("")

function typewriter() {
    document.getElementsByClassName('typewriter').innerHTML += text.shift();
}
