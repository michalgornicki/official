...
const Profile = () => {
  ...
  var text =
    "Self-taught, skilled, hefful and pro-active front end developer since 2019. Creating projects from templates or from scratch.";
  var i = 0;
  typewriter();
  function typewriter() {
    debugger;
  ...
  return (
    <div id="container1">
      ...
      <div className="text-wrapper" onMouseMove={mouseMove}>
        ...
        <h3 className="small">
          Self-taught, skilled, helpful and pro-active front end developer since
          2019. Creating projects from templates or from scratch.{" "}
        </h3>
      </div>
    </div>
  );
