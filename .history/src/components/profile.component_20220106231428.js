...
const Profile = () => {
  ...
  return (
    <div id="container1">
      ...
      <div className="text-wrapper" onMouseEnter={() => document.getElementsByClassName("wallpaper")[0].style.filter="blur(5px)"} on={() => document.getElementsByClassName("wallpaper")[0].style.filter="blur(0px)"}>
