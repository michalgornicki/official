...
const Profile = () => {
  ...
  const scrolling = () => {
    ...
    if (top/2 < 0) {
      ...
      document.getElementsByClassName("large")[0].style.left="0%"
      document.getElementsByClassName("medium")[0].style.right="0%"
  ...
  return (
    <div id="container1">
      ...
      <div className="text-wrapper" onMouseEnter={() => document.getElementsByClassName("wallpaper")[0].style.filter="blur(5px)"} >
        ...
        <h1 className="large" onClick={() => document.getElementsByClassName("large")[0].style.filter= "hue-rotate(" + Math.floor(Math.random() * 100000) + "deg)"}>Front-end developer</h1>
