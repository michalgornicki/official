...
const Profile = () => {
  ...
  const scrolling = () => {
    ...
    if (window.innerWidth > 800 ) document.getElementsByClassName("large")[0].style.transform="translate(" + (top/10 - 34) + "%)"
    else document.getElementsByClassName("large")[0].style.transform="translate(" + (top/10 - 25) + "%)"
  }
