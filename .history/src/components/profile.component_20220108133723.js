...
const Profile = () => {
  ...
  const scrolling = () => {
    ...
    if (window.innerWidth > 800 ) {
      document.getElementsByClassName("large")[0].style.transform="scale(" + (top/10) + ")"
      document.getElementsByClassName("medium")[0].style.transform="scale(" + (top/10 + 34) + ")"
      document.getElementsByClassName("small")[0].style.transform="scale(" + (- top/10 + 34) + ")"}
    else {
      document.getElementsByClassName("large")[0].style.transform="scale(" + (top/10 - 23) + ")"
      document.getElementsByClassName("medium")[0].style.transform="scale(" + (top/10 + 23) + ")"
      document.getElementsByClassName("small")[0].style.transform="scale(" + (top/10 + 23) + ")"
    }
  }
