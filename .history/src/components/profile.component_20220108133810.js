...
const Profile = () => {
  ...
  const scrolling = () => {
    ...
    if (window.innerWidth > 800 ) {
      document.getElementsByClassName("large")[0].style.transform="scale(" + (top/100) + ")"
      document.getElementsByClassName("medium")[0].style.transform="scale(" + (top/100) + ")"
      document.getElementsByClassName("small")[0].style.transform="scale(" + (- top/100) + ")"}
    else {
