...
const Projects = () => {
  ...
  const mouseMove = (e) => {
    ...
    document.getElementsByClassName("project-wrapper")[0].style.transform = "rotateX(" + (mousePosY/30 - 10).toFixed(2) + "deg) rotateY(" + (mousePosX/30 - 10).toFixed(2) + "deg)" ;
  };



  return (
    <div id="container2" data-aos="fade-up" onMouseMove={mouseMove}>
