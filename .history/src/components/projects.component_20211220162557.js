...
<a href="https://michalgornicki.github.io/electronet/"><Carousel.Caption className="bg-white w-50 m-auto black shadow">
  ...
  <Carousel.Item>
    ...
    <a href="https://github.com/michalgornicki/space_x_clone"><Carousel.Caption className="bg-white w-50 m-auto black shadow">
  ...
  <Carousel.Item>
    ...
    <a href="https://github.com/michalgornicki/bitcoin-virtual"><Carousel.Caption className="bg-white w-50 m-auto black shadow">
  ...
  <a href="https://github.com/michalgornicki/insta-note"><Carousel.Caption className="bg-white w-50 m-auto black shadow">
      <h3>Todo list app</h3>
      <p>React js, React hooks.</p>
    </Carousel.Caption></a>
  </Carousel.Item>
