...
const Projects = () => {
  const scrolling = () => {
    if (
      document.getElementById("container3").getBoundingClientRect().top < 200
    ) {
      document.getElementsByClassName("project-wrapper")[0].style.transform =
        "translateY(0%)";
      document.getElementsByClassName("project-wrapper")[0].style.filter =
        "opacity(1)";
    } else {
      document.getElementsByClassName("project-wrapper")[0].style.transform =
        "translateY(50%)";
        ...
        >
          ...
          <Carousel.Item>
            <img
              ...
              alt="First slide"
            />
            <a href="https://michalgornicki.github.io/smile-med/"> </a>
            <div className="carousel-text">
          ...
          <Carousel.Item>
            ...
            <a href="https://michalgornicki.github.io/smartify/"></a>
            <div className="carousel-text">
          ...
          <Carousel.Item>
            ...
            <a href="https://michalgornicki.github.io/electronet/"></a>
            <div className="carousel-text">
          ...
          <Carousel.Item>
            ...
            <a href="https://michalgornicki.github.io/space_x_clone"></a>
            <div className="carousel-text">
          ...
          <Carousel.Item>
            ...
            <a href="https://michalgornicki.github.io/bitcoin-virtual"></a>
            <div className="carousel-text">
          ...
          <Carousel.Item>
            ...
            <a href="https://michalgornicki.github.io/insta-note"></a>
            <div className="carousel-text">
              <h4>Todo list app</h4>
              <p>React js, React hooks.</p>
            </div>
          ...
          <Carousel.Item>
            ...
            <a href="https://www.youtube.com/watch?v=Xq_YM1_ebq4"> </a>
            <div className="carousel-text">
              <h4>Weather app</h4>
          ...
          <Carousel.Item>
            ...
            <a href="https://michalgornicki.github.io/virtualpet"></a>
            <div className="carousel-text">
