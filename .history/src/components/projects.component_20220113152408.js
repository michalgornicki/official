    ...
    <div id="container3">
      ...
      <div className="project-wrapper">
        ...
        <Carousel.Item>
            ...
            <p>On this website you can browse cat adoption announcements, search for specific cat, create your account, follow informations about selected pets and add your own announcements about cats looking for new home. Design is created Page is currently under development.</p>
            <a className="carousel-link" href="https://michalgornicki.github.io/lamborghinicars/"><p>Open website.</p></a>
            <a className="carousel-link" href="https://github.com/michalgornicki/lamborghinicars/"><p>Check design on Figma.</p></a>
            </div>
