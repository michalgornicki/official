    ...
    <div id="container3">
      ...
      <div className="project-wrapper">
        ...
        <Carousel.Item>
          ...
          <Carousel.Item>
            <img className="carousel-image d-block w-100"  alt="First slide" />
           
            
            <div className="carousel-text">
            <h4>Auction website [concept]</h4>
            <p>[Figma, React js, React Router, Bootstrap, Firebase database, Redux]</p>
            <p>My next project will be website to buy and sell products on auctions. There will be Redux state management and real time Firebased </p>
