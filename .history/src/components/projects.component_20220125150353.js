...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      image: Image11,
      description:
        "This is project to train my design and styling skills.",
    ...
    },
    {
      ...
      image: Image2,
      description:
        "I have created this website to train my design and styling skills.",
    ...
    },
    {
      ...
      image: Image5,
      description:
        " It is interesting app where you can find out if you can earn money with cryptocurrency trading. I wrotesimple algorythm to change value of two cryptocurrencies and save them in React state hooks. Account balance of PLN, BTC and ETH is also saved in state hook.",
      github: "https://github.com/michalgornicki/space_x_clone/",
      demo: "https://michalgornicki.github.io/space_x_clone/",
    }
  ];
        ...
        {projects.map((item => 
          ...
          <Carousel.Item>
            ...
            <div className="carousel-text">
              ...
              <p>
                On this website you can browse cat adoption announcements, search for specific cat, create your account,
                follow informations about selected pets and add your own announcements about cats looking for new home.
                I created design for this project in Figma. Page is currently under development.
              </p>
              <a className="carousel-link" href="https://michalgornicki.github.io/cats/">
                <p>Open website.</p>
              </a>
              <a className="carousel-link" href="https://github.com/michalgornicki/cats/">
                <p>Check code on Github.</p>
              </a>
              <a
                className="carousel-link"
                href="https://www.figma.com/file/6zDs92xmPHCsTPWngIb3pQ/Adoptuj-Kota?node-id=10%3A87/"
              >
                <p>Check design on Figma.</p>
              </a>
            </div>
          </Carousel.Item>
          ...
          <Carousel.Item>
            ...
            <div className="carousel-text">
              ...
              <p>
                My next project will be website to buy and sell products on auctions. There will be Redux state
          ...
          <Carousel.Item>
            ...
            <div className="carousel-text">
              ...
              <a className="carousel-link" href="https://michalgornicki.github.io/lamborghinicars/">
                <p>Open website.</p>
              </a>
              <a className="carousel-link" href="https://github.com/michalgornicki/lamborghinicars/">
                <p>Check code on Github.</p>
              </a>
            </div>
          </Carousel.Item>
          <Carousel.Item>
            ...
            <div className="carousel-text">
              ...
              <a className="carousel-link" href="https://michalgornicki.github.io/Impromptu/">
                <p>Open website.</p>
              </a>
              <a className="carousel-link" href="https://github.com/michalgornicki/Impromptu/">
                <p>Check code on Github.</p>
              </a>
            </div>
          </Carousel.Item>
          <Carousel.Item>
            ...
            <div className="carousel-text">
              ...
              <p>
                In this project I started using regularly Bootstrap, which is such a great help in styling. Purpose of
                this project was to strengthen styling skills and developing using Bootstrap. I started here using React
                router which is also wonderful tool.
              </p>
              <a className="carousel-link" href="https://michalgornicki.github.io/smile-med/">
                <p>Open website.</p>
              </a>
              <a className="carousel-link" href="https://github.com/michalgornicki/smile-med/">
                <p>Check code on Github.</p>
              </a>
            </div>
          </Carousel.Item>
          <Carousel.Item>
            ...
            <div className="carousel-text">
              ...
              <a className="carousel-link" href="https://michalgornicki.github.io/smartify/">
                <p>Open website.</p>
              </a>
              <a className="carousel-link" href="https://github.com/michalgornicki/smartify/">
                <p>Check code on Github.</p>
              </a>
            </div>
          </Carousel.Item>
          <Carousel.Item>
            ...
            <div className="carousel-text">
              ...
              <p>[React JS]</p>
              <p>
                In this project I have recreated website of electronics shop. There are lot of possibilities: you can
                find items through search, sort them by price, by category, add items to basket. There is also form with
                validation.
              </p>
              <a className="carousel-link" href="https://michalgornicki.github.io/electronet/">
                <p>Open website.</p>
              </a>
              <a className="carousel-link" href="https://github.com/michalgornicki/electronet/">
                <p>Check code on Github.</p>
              </a>
            </div>
          </Carousel.Item>
          ...
          <Carousel.Item>
            ...
            <div className="carousel-text">
              ...
              <p>
                I have created this project to train my skills with using larger database. It is a bit rough for now,
                but is very informative.
              </p>
              <a className="carousel-link" href="https://michalgornicki.github.io/space_x_clone/">
                <p>Open website.</p>
              </a>
              <a className="carousel-link" href="https://github.com/michalgornicki/space_x_clone/">
                <p>Check code on Github.</p>
              </a>
            </div>
          </Carousel.Item>
          <Carousel.Item>
            ...
            <div className="carousel-text">
              ...
              <p>
                It is interesting app where you can find out if you can earn money with cryptocurrency trading. I wrote
                simple algorythm to change value of two cryptocurrencies and save them in React state hooks. Account
                balance of PLN, BTC and ETH is also saved in state hook.{" "}
              </p>
              <a className="carousel-link" href="https://michalgornicki.github.io/bitcoin-virtual/">
                <p>Open website.</p>
              </a>
              <a className="carousel-link" href="https://github.com/michalgornicki/bitcoin-virtual/">
                <p>Check code on Github.</p>
              </a>
            </div>
          </Carousel.Item>
          <Carousel.Item>
            ...
            <div className="carousel-text">
              ...
              <p>[React js, React hooks]</p>
              <p>
                There it is, classic Todo app created in React js with using of state hooks. I have created this app to
                have a little training with manipulating arrays.
              </p>
              <a className="carousel-link" href="https://michalgornicki.github.io/insta-note/">
                <p>Open website.</p>
              </a>
              <a className="carousel-link" href="https://github.com/michalgornicki/insta-note/">
                <p>Check code on Github.</p>
              </a>
            </div>
          </Carousel.Item>
          <Carousel.Item>
            ...
            <div className="carousel-text">
              ...
              <p>
                This is app created to work with Rest API of openweather weather website. You can check weather in any
                city in the world. There is also avalaible forecast for 3 next days. App is offering info about
                temperature, wind and visibility. You can download this application from my Github and use it with your
                own API which you can get from openweatherapp.com.{" "}
              </p>
              <a className="carousel-link" href="https://www.youtube.com/watch?v=Xq_YM1_ebq4/">
                <p>watch website on Youtube.</p>
              </a>
            </div>
          </Carousel.Item>
          <Carousel.Item>
            ...
            <div className="carousel-text">
              ...
              <p>[HTML, CSS, JS]</p>
              <p>
                I have created this project to develop objects with different properties in Javascript. You can choose
                animal which would you like to pet. Each animal have different needs, so you must feed, drink and play
                with them.{" "}
              </p>
              <a className="carousel-link" href="https://michalgornicki.github.io/virtualpet/">
                <p>Open website.</p>
              </a>
              <a className="carousel-link" href="https://github.com/michalgornicki/virtualpet/">
                <p>Check code on Github.</p>
              </a>
            </div>
          </Carousel.Item>
