...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      image: Image9,
      description:
        "I have created this project to develop objects with different properties in Javascript. You can chooseanimal which would you like to pet. Each animal have different needs, so you must feed, drink and play
        with them.",
      github: "https://github.com/michalgornicki/weather-app/",
      demo: "https://www.youtube.com/watch?v=Xq_YM1_ebq4/",
    }
