...
const Projects = () => {
  ...
  const projects = [
    ...
    {
      title: "Javascript, React and Git repeat courses",
      techs: "React js, React Router, Bootstrap",
      image: Image14,
      description:
        "These projects were created to help people learn and repeat most essential javascript, react and git knowledge.",
