...
const Projects = () => {
  const scrolling = () => {
    if (document.getElementById("container-projects").getBoundingClientRect().top < 400) {
      document.getElementsByClassName("container-projects__project-wrapper")[0].style.transform = "translateY(0%)";
      document.getElementsByClassName("container-projects__project-wrapper")[0].style.filter = "opacity(1)";
    } else {
      document.getElementsByClassName("container-projects__project-wrapper")[0].style.transform = "translateY(50%)";
      document.getElementsByClassName("container-projects__project-wrapper")[0].style.filter = "opacity(0)";
    }
  };
  ...
  return (
    <section id="container-projects" className="section">
      <h2 className="section__header">
        Projects
      </h2>

      <div className="container-projects__project-wrapper">
