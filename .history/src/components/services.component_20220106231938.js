  ...
  return (
    <div id="container4">
      ...
      <div className="service-wrapper">
        <div className="service"onMouseEnter={() => {document.getElementsByClassName("service")[0].style.transform="scale(1.1)"; document.getElementsByClassName("service")[1].style.transform="scale(1.1)"}}>
