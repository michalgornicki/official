...
const Services = () => {
  ...
  const scrolling = () => {
    if (document.getElementById("container5").getBoundingClientRect().top < 200) {
     document.getElementsByClassName("service-wrapper")[0].style.transform="translateY(50%)";
     document.getElementsByClassName("service-wrapper")[0].style.filter="opacity(1)";
  }
   else {document.getElementsByClassName("service-wrapper")[0].style.transform="translateY(0%)";
