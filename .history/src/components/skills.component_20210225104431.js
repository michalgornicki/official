...
const Skills = () => {
    ...
    return(
      ...
      <div><div className="skill violet" data-aos="zoom-up" data-aos-delay="600"><span class="skill-title">CSS</span> <div className="skill-description">I know CSS very well. Styling, positioning, animations are familiar to me. I also used CSS frameworks as Bootstrap and Tailwind. </div></div></div>
      <div><div className="skill red" data-aos="zoom-up" data-aos-delay="900"><span class="skill-title">JAVASCRIPT</span> <div className="skill-description">I know javascript pretty well. I practice this language to get used to more advanced concepts.</div></div></div>
