...
const Skills = () => {
    ...
    return(
      ...
      span      <div className="skill blue" data-aos="zoom-up" data-aos-delay="600"><span class="skill-title">REACT</span> <div className="skill-description">This is my main focus. I'm now working on React projects.</div></div>
