...
const Skills = () => {
    ...
    return(
      ...
      <span data-aos="zoom-up" data-aos-delay="300"><div className="skill blue"><span class="skill-title">HTML</span> <div className="skill-description">I feel strong in HTML.</div></div></span>
      <span data-aos="zoom-up" data-aos-delay="600"><div className="skill violet"><span class="skill-title">CSS</span> <div className="skill-description">I know CSS very well. Styling, positioning, animations are familiar to me. I also used CSS frameworks as Bootstrap and Tailwind. </div></div></span>
      <span data-aos="zoom-up" data-aos-delay="900"><div className="skill red"><span class="skill-title">JAVASCRIPT</span> <div className="skill-description">I know javascript pretty well. I practice this language to get used to more advanced concepts.</div></div></span>
