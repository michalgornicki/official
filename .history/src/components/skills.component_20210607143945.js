  ...
  return (
    <div id="container3" data-aos="fade-up" data-aos-offset="0">
      ...
      <div className="skill-wrapper">
        ...
        <div className="skill blue" data-aos="zoom-up" data-aos-delay="600">
          <span class="skill-title">ATOM</span>{" "}
          <div className="skill-description">
            I worked in Atom editor for about 12 months.
          </div>
        </div>
        <div className="skill violet" data-aos="zoom-up" data-aos-delay="900">
          <span class="skill-title">VISUAL STUDIO CODE</span>{" "}
          <div className="skill-description">
        ...
        <div className="skill red" data-aos="zoom-up" data-aos-delay="600">
          ...
          <div className="skill-description">
            I worked a lot in Photoshop for retouching photos.
          </div>
        </div>
        <div className="skill blue" data-aos="zoom-up" data-aos-delay="300">
