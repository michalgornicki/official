  ...
  return (
    <div id="container3">
      ...
      <div className="skill-wrapper">
        ...
        <div className="skill">
        <abbr title="CSS and LESS ✰✰✰✰✰"><img className="tech-icon" src={sass} alt="" /></abbr>
        </div>
        <div className="skill">
        <abbr title="Javascript ✰✰✰✰"><img className="tech-icon" src={redux} alt="" /></abbr>
        </div>
        <div className="skill">
        <abbr title="React JS and React hooks ✰✰✰"><img className="tech-icon" src={typescript} alt="" /></abbr>
        </div>
