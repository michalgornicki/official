...
const Skills = () => {
  ...
  const scrolling = () => {
    if (document.getElementById("container4").getBoundingClientRect().top < 200) {
     document.getElementsByClassName("skill-wrapper")[0].style.transform="opacity(1)";
     document.getElementsByClassName("skill-wrapper")[1].style.transform="translateY(0%)";
  }
   else {document.getElementsByClassName("skill-wrapper")[0].style.transform="opacity";
        document.getElementsByClassName("skill-wrapper")[1].style.transform="translateY(50%)";}
}
